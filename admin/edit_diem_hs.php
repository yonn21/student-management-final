...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Bảng điểm học sinh:</h1>
        </div>
    </div>
    <!--/.row-->
    <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <form method="post">
                                    ...
                                    <td class="form-group"><input style="width: 80px;" type="text" name="DiemMieng"
                                            value="<?php echo $row_view['DiemMieng']; ?>"></td>
                                    <td class="form-group"><input style="width: 80px;" type="text" name="Diem15Phut1"
                                            value="<?php echo $row_view['Diem15Phut1']; ?>"></td>
                                    <td class="form-group"><input style="width: 80px;" type="text" name="Diem15Phut2"
                                            value="<?php echo $row_view['Diem15Phut2']; ?>"></td>
                                    <td class="form-group"><input style="width: 80px;" type="text" name="Diem1Tiet1"
                                            value="<?php echo $row_view['Diem1Tiet1']; ?>"></td>
                                    <td class="form-group"><input style="width: 80px;" type="text" name="Diem1Tiet2"
                                            value="<?php echo $row_view['Diem1Tiet2']; ?>"></td>
                                    <td class="form-group"><input style="width: 80px;" type="text" name="DiemThi"
                                            value="<?php echo $row_view['DiemThi']; ?>"></td>
                                    <?php
