...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div id="toolbar" class="btn-group">
        <a href="index.php?page=add_monhoc" class="btn btn-success <?php if ($_SESSION['user_level'] == 2) {
                                                                        echo 'disabled';
                                                                    } ?>">
                    ...
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    <a href="index.php?page=edit_monhoc&monhoc_id=<?php echo $row['MaMonHoc']; ?>"
                                        class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                    <a onclick=" return thongbao();"
                                        href="del_monhoc.php?monhoc_id=<?php echo $row['MaMonHoc']; ?>"
