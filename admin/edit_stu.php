...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li><a href="index.php?page=list_stu">Quản lý Lớp Học</a></li>
                    ...
                    <div class="col-md-8">
                        ...
                        <form role="form" method="post">
                            <div class="form-group">
                                ...
                                <input name="stu_id" required type="text" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="class_id">
                                    ...
                                    ?>
                                    <option value="<?php echo $row_view['MaLopHoc'] ?>" <?php if ($row['MaLopHoc'] == $row_view['MaLopHoc']) {
                                                                                                echo 'selected';
                                                                                            } ?>>
                                        <?php echo $row_view['Tenlophoc'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
