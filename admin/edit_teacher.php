...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Giáo viên: <?php echo $row_view['TenGV']; ?></h1>
        </div>
    </div>
    <!--/.row-->
    <div class="row">
                        ...
                        <form role="form" method="post">
                            <div class="form-group">
                                ...
                                <input type="number" name="teacher_id" class="form-control"
                                    value="<?php echo $row_view['MaGV']; ?>" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Họ & Tên</label>
                                <input type="text" name="teacher_name" class="form-control"
                                    value="<?php echo $row_view['TenGV']; ?>" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" name="teacher_mail" value="<?php echo $row_view['gv_mail']; ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Địa Chỉ</label>
                                <input name="teacher_address" required type="text" class="form-control"
                                    value="<?php echo $row_view['DiaChi']; ?>">
                            </div>
                            <div class="form-group">
                                <label>SĐT</label>
                                <input name="teacher_phone" required type="number" class="form-control"
                                    value="<?php echo $row_view['SDT']; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="teaching" class="form-control">
                                    ...
                                    ?>
                                    <option value=<?php echo $row_mon_hoc['MaMonHoc']; ?> <?php if ($row_mon_hoc['MaMonHoc'] == $row_view['MaMonHoc']) {
                                                                                                    echo 'selected';
                                                                                                } ?>>
                                        <?php echo $row_mon_hoc['TenMonHoc'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
