...
if (isset($_GET['keyword'])) {
    ...
    if (mysqli_num_rows($query) == "") {
        echo '<script>';
        echo 'alert("Không tìm thấy mã hoặc tên học sinh vừa nhập!")';
        echo '</script>';
        $err = 1;
        echo '<script>';
                    ...
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    <a href="index.php?page=edit_diem&id_hs=<?php echo $row['MaHS']; ?>"
                                        class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a>
                                </td>
                                <td class="form-group">
                                    <a href="index.php?page=edit_stu&id_hs=<?php echo $row['MaHS']; ?>"
