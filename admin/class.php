                    ...
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    <a href="index.php?page=list_stu&id_class=<?php echo $row['MaLopHoc']; ?>"
                                        class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a>
                                </td>
                                <td class="form-group">
                                    <a href="index.php?page=edit_class&id_class=<?php echo $row['MaLopHoc']; ?>"
                                        class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                    <a onclick=" return thongbao();"
                                        href="del_class.php?id_lop=<?php echo $row['MaLopHoc']; ?>"
                                        class="btn btn-danger <?php if ($_SESSION['user_level'] == 2) {
                                                                                                                                                                echo 'disabled';
                                                                                                                                                            } ?>"><i
