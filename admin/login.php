            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST">
                    ...
                    <span class="login100-form-title">
                        Thăng Long - Đăng nhập
                        <a href="../index.php" class="txt0">
                            <p class="fa fa-long-arrow-left m-l-5"> Quay lại trang chủ</p>
                        </a>
                    </span>
                    ...
                    <div class=" wrap-input100 validate-input" data-validate="Vui lòng nhập email (abc@xyz.ww)">
                        <input class="input100" type="text" name="mail" placeholder="Email" value="<?php if (isset($_COOKIE["username"])) {
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Vui lòng nhập mật khẩu">
                        <input class="input100" type="password" name="pass" placeholder="Mật khẩu" value="<?php if (isset($_COOKIE["password"])) {
