...
if (isset($_POST['mail'])) {
    ...
    if ($count == 1) {
        ...
        try {
            ...
            $mail->Username   = 'pv210802@gmail.com';                     // SMTP username
            $mail->Password   = 'ymcrrihamqcdrbzt';                               // SMTP password
            $mail->SMTPSecure = 'ssl';                                  // Enable TLS encryption, `ssl` also accepted
            $mail->Port       = 465;                                    // TCP port to connect to
            $mail->CharSet = "UTF-8";
            //Recipients: Người Nhận
            $mail->setFrom('pv210802@gmail.com', 'PTTH Thăng Long');
            ...
            <form role="form" method="post">
                <fieldset>
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="E-mail" name="mail" type="email" id="mail" autofocus
                            required>
                    </div>
