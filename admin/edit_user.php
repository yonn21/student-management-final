                        ...
                        <form role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_name" class="form-control"
                                    value="<?php echo $row_view['user_name']; ?>" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" name="user_mail" value="<?php echo $row_view['user_mail']; ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_level" class="form-control">
                                    <option value=1 <?php if ($row_view['user_level'] == 1) {
                                                        echo 'selected';
                                                    } ?>>Admin</option>
                                    <option value=2 <?php if ($row_view['user_level'] == 2) {
                                                        echo 'selected';
                                                    } ?>>Member</option>
                                </select>
                            </div>
